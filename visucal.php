...
echo '<table width="1000" >
  ...
  <table width="100%" align="center"><tr>
	...
	?>
	<select name="seleccal" id="seleccal" class="datospf" OnChange="fajax('./odbc/guardar.php','calificaciones','codigos=987789&valor='+this.value+'&exp_e=<?php echo $exp_e;?>','post','0');">
